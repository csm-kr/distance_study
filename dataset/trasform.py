...
def transform(image, boxes, labels, split, new_size):
    ...
    new_image, new_boxes = resize(new_image, new_boxes, dims=(new_size, new_size))
...
def transform_for_retina(image, boxes, labels, split, new_size):
